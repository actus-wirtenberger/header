...
export class Header implements BlockTool {
  ...
  public _CSS: any
  public _settings: HeaderConfig
  public _data: HeaderData
  public settingsButtons: HTMLElement[]
  public _element: HTMLHeadingElement

  /**
   * Render plugin`s main Element and fill it with saved data
   *
   * @param {{data: HeaderData, config: HeaderConfig, api: object, readOnly: boolean}}
   ...
   * @private
   */
  normalizeData(data: any): HeaderData {
    const newData:
      | {
          level: number
          text: { [attr: string]: boolean | string }
        }
      | any = {}
  ...
  setLevel(level: any) {
     ...
     */
    this.settingsButtons.forEach((button: any) => {
   ...
   * @public
   */
  save(toolsContent: any): HeaderData {
    return {
  ...
  onPaste(event: any) {
    ...
    if (this._settings.levels) {
      ...
      level = this._settings.levels.reduce((prevLevel: any, currLevel: any) => {
